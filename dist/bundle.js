...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"Light\", function() { return Light; });\n/* harmony import */ var _primitives__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./primitives */ \"./src/webgl/primitives.js\");\n\n\nclass Light {\n    constructor (position, color) {\n        this.position = position;\n        this.color = color;\n\n        this.glsl_position = null;\n\n    }\n\n    initSelf(gl, program) {\n        this.glsl_position = new _primitives__WEBPACK_IMPORTED_MODULE_0__[\"GLSLVarVec3\"](gl, program, 'lightPosition');\n        this.glsl_color = new _primitives__WEBPACK_IMPORTED_MODULE_0__[\"GLSLVarVec3\"](gl, program, 'lightColor');\n    }\n\n    uploadSelf(gl) {\n        this.glsl_position.upload(gl, this.position);\n        this.glsl_color.upload(gl, this.color);\n    }\n}\n\n\n\n//# sourceURL=webpack:///./src/webgl/light.js?");
